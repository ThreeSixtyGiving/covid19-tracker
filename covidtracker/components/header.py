...
def header():
    return html.Header(className="layout__header", children=[
        html.Div(className="hero-section", children=[
            html.Div(className="wrapper", children=[
                html.Div(className="hero hero--red", children=[
                    html.Div(className="hero__column hero__logo", children=[
                        html.A(href="https://threesixtygiving.org/", children=[
                            html.Img(src="https://www.threesixtygiving.org/wp-content/themes/360giving2020/assets/images/360-logos/360giving-main.svg", alt="360 Main"), 
                        ]),
                    ]),
